...
public class InquiryCommand implements MCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
		...
		SM.inquiry(companyname, companynamekatakana, name, namekatakana, mail, phone, fax, addressno, kenn, addressnumber, apt, message);
